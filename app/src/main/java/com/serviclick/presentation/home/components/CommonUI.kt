...
/**
 * Componentes de UI y funciones utilitarias compartidas en toda la aplicación.
 */
...
/**
 * Componente que decodifica y muestra una imagen desde un String en Base64.
 */
@Composable
...
/**
 * Función utilitaria para transformar y comprimir imágenes (Uri) a Base64 antes de subirlas a Firebase.
 */
...
//Formateador inteligente de reseñas para redondear grandes números en la UI (ej. 1500 -> +1k)
