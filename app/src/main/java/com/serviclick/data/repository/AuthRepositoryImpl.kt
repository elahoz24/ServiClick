...
/**
 * Implementación concreta de la autenticación de usuarios usando Firebase Auth y Firestore.
 * Gestiona el acceso, registro y recuperación de contraseñas de los usuarios.
 * Realiza llamadas a Firebase Auth envolviéndolas con `.await()` para usar Corrutinas.
 * Al registrar un usuario, también crea un documento inicial en Firestore (`users`) con su rol.
 */
class AuthRepositoryImpl @Inject constructor() : AuthRepository {
    ...
    override suspend fun login(email: String, pass: String): Result<Unit> = try {
        ...
        // Se traduce el error capturado antes de enviarlo a la capa de UI
    ...
    override suspend fun register(email: String, pass: String, role: String): Result<Unit> = try {
        ...
        // Se guarda el rol en la base de datos vinculándolo al UID de autenticación
    ...
    /**
     * Mapea las excepciones de Firebase a cadenas de texto localizadas para el usuario final.
     */
